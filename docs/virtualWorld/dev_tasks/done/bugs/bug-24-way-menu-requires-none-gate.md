...
(`!way.requires` fails), â›° marker + hover text shown.
...
- Browser: reload panel â†’ restroom door menu must show enabled Go + Open;
  no "requires none" reason text, no â›° marker.
