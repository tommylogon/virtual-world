...
- **Periodic**: thin placeholder — real effect is **insulation modifier** on clothing, not a direct drain. Insulation math: a wet garment's insulation value is multiplied down; wet body parts chill faster â†’ feeds `hypothermia` onset.
