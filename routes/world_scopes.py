...
def register_world_scopes_routes(app):
    ...
    @app.route('/api/world/scopes/<scope_id>/subgraph', methods=['GET'])
    def world_scope_subgraph(scope_id):
        return handle_scope_subgraph(app, scope_id)
