...
CONDITION_DEFINITIONS = {
    ...
    # ── Arousal state conditions (task-209) — gated by world.mature_content ──
    "warming_up": {
        "name": "Warming Up", "description": "A pleasant warmth spreads. Interest is building.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Stimulation": 1}, "ends_on": ["cool_down", "relax"],
        "known": False, "symptoms": {
            3: "A pleasant warmth spreads through you.",
            1: "Your skin feels hot to the touch.",
        }, "stack": "refresh", "default_duration": 20,
        "excludes": [],
    },
    "aroused": {
        "name": "Aroused", "description": "Distractingly stimulated. Focus slips.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": ["perception", "concentration"], "auto_fail_saves": [],
        "attack_mod": -2, "defense_mod": -2, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Stimulation": 2}, "ends_on": ["cool_down", "relax"],
        "known": False, "symptoms": {
            3: "Your thoughts keep wandering to that touch.",
            1: "It's hard to focus on anything else.",
        }, "stack": "refresh", "default_duration": 20,
        "excludes": [],
    },
    "highly_aroused": {
        "name": "Highly Aroused", "description": "Barely in control. Everything else fades.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": ["perception", "concentration", "willpower"], "auto_fail_saves": [],
        "attack_mod": -3, "defense_mod": -3, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Stimulation": 3, "Energy": -2}, "ends_on": ["release", "cool_down"],
        "known": False, "symptoms": {
            3: "Every nerve is lit. Your breath comes short.",
            1: "You're shaking with need.",
        }, "stack": "refresh", "default_duration": 20,
        "excludes": [],
    },
    "frantic": {
        "name": "Frantic", "description": "Desperate for release. Reason is on hold.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": ["perception", "concentration", "willpower", "self_control"], "auto_fail_saves": [],
        "attack_mod": -5, "defense_mod": -5, "speed_mult": 0.9,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Stimulation": 4, "Energy": -3, "Sanity": -2},
        "ends_on": ["release", "cool_down"],
        "known": True, "symptoms": {
            3: "You need release. Nothing else matters.",
            1: "Your body screams for it.",
        }, "stack": "refresh", "default_duration": 15,
        "excludes": [],
    },
    "overstimulated": {
        "name": "Overstimulated", "description": "Too much. Pleasure curdles into overload.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": -1, "defense_mod": -1, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Pleasure": -3, "Energy": -1}, "ends_on": ["duration"],
        "known": False, "symptoms": {
            3: "Sensitivity peaks turn to overshoot. Too much.",
            1: "Every touch is almost too intense to bear.",
        }, "stack": "refresh", "default_duration": 5,
        "excludes": [],
    },
    "nipple_hard": {
        "name": "Nipple Hard", "description": "Cold or aroused — their nipples stand out against the fabric.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Arousal": 1}, "ends_on": ["warm_up", "cool_down"],
        "known": True, "symptoms": {}, "stack": "refresh", "default_duration": 15,
        "excludes": [],
    },
    "blushing": {
        "name": "Blushing", "description": "Cheeks flushed. Visibly flustered.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {}, "ends_on": ["duration", "cool_down"],
        "known": True, "symptoms": {}, "stack": "refresh", "default_duration": 8,
        "excludes": [],
    },
    "wetness": {
        "name": "Wetness", "description": "Arousal makes itself physically known.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Arousal": 2}, "ends_on": ["cool_down"],
        "known": False, "symptoms": {}, "stack": "refresh", "default_duration": 15,
        "excludes": [],
    },
    "sensitized": {
        "name": "Sensitized", "description": "Edged and receptive. Every touch counts double.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {"Stimulation": 1}, "ends_on": ["duration", "release"],
        "known": False, "symptoms": {}, "stack": "accumulate", "default_duration": 10,
        "excludes": [],
    },
    "satisfied": {
        "name": "Satisfied", "description": "Released and content. Drowsy and at peace.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {}, "ends_on": ["duration"],
        "known": False, "symptoms": {
            5: "A slow, warm contentment settles over you.",
            3: "You feel languid and sated.",
        }, "stack": "refresh", "default_duration": 20,
        "excludes": [],
    },
    # ── Low-Social breakdown (task-353 §5) ──────────────────────────────
    "social_breakdown": {
        "name": "Social Breakdown", "description": "Desperate isolation. Behavior becomes erratic.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": -2, "defense_mod": -2, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        ...
        "known": False, "symptoms": {
            ...
            1: "Reality feels thin when you talk to shadows.",
    ...
    # mature_content toggle.
    "itch": {
        "name": "Itch", "description": "Unbearably itchy. You can't stop scratching.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {}, "ends_on": ["scratch", "cure", "duration"],
        "known": False, "symptoms": {
            5: "You scratch at the itch without thinking.",
            3: "The itching is maddening. You rub the spot raw.",
            1: "Every nerve screams to scratch.",
        }, "stack": "refresh", "default_duration": 10,
        "excludes": [],
    },
    "goosebumps": {
        "name": "Goosebumps", "description": "A chill raises the hairs on your skin.",
        "blocks_actions": False, "blocks_movement": False, "blocks_speech": False,
        "auto_fail_checks": [], "auto_fail_saves": [],
        "attack_mod": 0, "defense_mod": 0, "speed_mult": 1.0,
        "movement_mode": None, "drops_held_items": False,
        "periodic": {}, "ends_on": ["warm_up", "duration"],
        "known": False, "symptoms": {
            3: "The hairs on your arms stand on end.",
            1: "You can't shake the prickling on your skin.",
