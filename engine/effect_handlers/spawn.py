...
def handle_spawn_character(self, params, context, item_node=None, game_state=None):
    ...
    player_obj, lib_data = self._hydrate_character(char_id, params, game_state, always_fresh=True)
    ...
    # task-445: carry the library character's expression pack onto its node so
